...
it accepts romans in that notation, any extras where they dont belong will give an error.
...
validate roman accepts the empty string, and it will be treated as 0, but roman to array function prevents it from being accepted as input.
